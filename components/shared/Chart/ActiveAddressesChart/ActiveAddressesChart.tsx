...
const ACTIVE_WALLETS_ALL_TIME = gql`
  query GetActiveWalletsAlltime @cached {
    v_active_addresses(order_by: { date: desc }) {
      date
      number_of_activeadrs_wo_err
    }
  }
`;
...
const ActiveAddressesChart = () => {
  ...
  const { data: dataAlltime, loading: loadingAlltime } = useQuery(
    ACTIVE_WALLETS_ALL_TIME
  );
  if (loadingAlltime) {
    return <Loader />;
  }
