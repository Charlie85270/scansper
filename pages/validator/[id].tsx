        ...
        <div className="w-full mb-4 xl:w-1/4">
          <Card>
            <div>
              ...
              <div
                className="flex-col items-center justify-center my-4"
                id="chart"
              >
              ...
              <div className="py-2 mt-4 border-b">
                <p className="text-sm text-gray-400">Public key</p>
                <p className="text-gray-800 truncate text-md">
                ...
                <span className="flex items-center space-x-2">
                  <span className="text-gray-800 text-md">
                    {formatNumber(
                      Number(
                        Number(
                          Number(dataTotalDelegatorRewards?.data) / MOTE_VALUE
                        ).toFixed(0)
                      )
                    )}
                  </span>
